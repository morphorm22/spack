...
class Dakota(CMakePackage):
    ...
    def url_for_version(self, version):
        if version < Version('6.14'):
            url = 'https://dakota.sandia.gov/sites/default/files/distributions/public/dakota-{0}-release-public.src.tar.gz'
        else:
            url = 'https://dakota.sandia.gov/sites/default/files/distributions/public/dakota-{0}.0-release-public-src-cli.tar.gz'
