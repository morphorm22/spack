...
class Trilinos(CMakePackage, CudaPackage):
    ...
    variant('amesos2',      default=False, description='Compile with Amesos2')
    ...
    variant('chaco',        default=True, description='Compile with Chaco from SEACAS')
    ...
    variant('exodus',       default=True, description='Compile with Exodus from SEACAS')
    variant('ifpack',       default=True, description='Compile with Ifpack')
    variant('ifpack2',      default=False, description='Compile with Ifpack2')
    variant('intrepid',     default=True, description='Enable Intrepid')
    ...
    variant('gtest',        default=True, description='Build vendored Googletest')
    variant('kokkos',       default=True, description='Compile with Kokkos')
    variant('kokkoskernels',default=True, description='Compile with KokkosKernels')
    ...
    variant('shards',       default=True, description='Compile with Shards')
    ...
    patch('seacas_remove_zlib.patch')
