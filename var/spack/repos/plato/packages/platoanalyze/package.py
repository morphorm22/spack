...
# tpl_update
    depends_on('platoengine~unit_testing+stk+iso+expy+esp+prune@tpl_update',            when='@tpl_update' )
    ...
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=75', when='@tpl_update compute_capability=75')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=70', when='@tpl_update compute_capability=70')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=61', when='@tpl_update compute_capability=61')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=60', when='@tpl_update compute_capability=60')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=52', when='@tpl_update compute_capability=52')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=37', when='@tpl_update compute_capability=37')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=35', when='@tpl_update compute_capability=35')
    depends_on('trilinos+cuda+wrapper+chaco+zoltan~zoltan2~tpetra+shards~muelu~ifpack~ifpack2~belos~amesos2~amesos~suite-sparse~hypre+intrepid@13.0.1 cxxstd=14 cuda_arch=30', when='@tpl_update compute_capability=30')

    # this pattern isn't elegant, but it works.  (Is there a better way to forward a variant value?)
    depends_on('amgx@2.2.0 cuda_arch=75', when='+amgx compute_capability=75')
    depends_on('amgx@2.2.0 cuda_arch=70', when='+amgx compute_capability=70')
    depends_on('amgx@2.2.0 cuda_arch=61', when='+amgx compute_capability=61')
    depends_on('amgx@2.2.0 cuda_arch=60', when='+amgx compute_capability=60')
    depends_on('amgx@2.2.0 cuda_arch=52', when='+amgx compute_capability=52')
    depends_on('amgx@2.2.0 cuda_arch=37', when='+amgx compute_capability=37')
    depends_on('amgx@2.2.0 cuda_arch=35', when='+amgx compute_capability=35')
    depends_on('amgx@2.2.0 cuda_arch=30', when='+amgx compute_capability=30')
#end
