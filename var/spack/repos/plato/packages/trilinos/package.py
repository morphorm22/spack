...
class Trilinos(CMakePackage, CudaPackage, ROCmPackage):
    ...
    variant('pamgen',       default=False, description='Compile with Pamgen') #added by plato team
    variant('percept',      default=False, description='Compile with percept') #added by plato team
    ...
    variant('teuchos',      default=True, description='Compile with Teuchos') # required by plato team
    ...
    conflicts('pamgen', when='%xl') #added by plato team
    ...
    def cmake_args(self):
        ...
        options.extend([
            ...
            define_trilinos_enable('Teuchos'), # required by plato
        ...
        options.extend([
            ...
            define('KOKKOS_ARCH_BDW', False), # added by plato team
            define('KOKKOS_ARCH_HSW', False) # added by plato team
        ])
        ...
        if '+kokkos' in spec:
            ...
            if '+cuda' in spec:
                options.extend([
                    define_kok_enable('CUDA_UVM', False),
